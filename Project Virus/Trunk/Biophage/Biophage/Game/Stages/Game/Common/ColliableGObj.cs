...
{
    /// <summary>
    /// Represents a collidable game object - inherits CollisonSkin.
    /// </summary>
    public abstract class ColliableGObj : CollisionSkin, IGameObject
    {
        #region fields
            ...
            : base()
        {
            ...
            if (addToScene)
            {
                ...
                scene.AddGameObj((IGameObject)this);
            }
