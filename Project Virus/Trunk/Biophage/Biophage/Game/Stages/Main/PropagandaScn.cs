...
namespace Biophage.Game.Stages.Main
{
    ...
    class PropagandaScn : Scene
    {
        ...
        public static PropagandaScn Create( DebugManager debugMgr, ResourceManager resourceMgr,
                                            Microsoft.Xna.Framework.GraphicsDeviceManager graphicsMgr,
                                            Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch,
                                            Scene parent)
        {
            PropagandaScn scn = new PropagandaScn(
                GlobalConstants.PROPAGANDA_SCN_ID, debugMgr, resourceMgr, graphicsMgr, spriteBatch,
            ...
            TextureAsset propagandaTitle = new TextureAsset(
                2, Microsoft.Xna.Framework.Vector3.Zero,
                1.92f, 1.08f, "Content\\MainStage", "PropagandaTitle",
                debugMgr, resourceMgr, scn, true,
                graphicsMgr);
