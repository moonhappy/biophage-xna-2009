...
{
    /// <summary>
    /// Represents a fuzzy set with a 'left-shoulder' shape.
    /// </summary>
    public class FzSetLeftShoulder : FuzzySet
    {
        #region feilds
        ...
        /// </param>
        public FzSetLeftShoulder(   DebugManager debugMgr,
                                    double peak,
                                    double leftOffset,
                                    double rightOffset)
            : base(debugMgr, peak - (leftOffset / 2.0))
        {
            m_peak = peak;
