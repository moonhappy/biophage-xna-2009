...
{
    /// <summary>
    /// Represents a handle to a SpriteFont resource. This class is
    /// implicitly thread safe providing a serialised access policy.
    /// </summary>
    public class SpriteFontResHandle : ResourceHandle<SpriteFontRes>
    {
        #region construction
        ...
        /// </param>
        public SpriteFontResHandle( DebugManager debugMgr, ResourceManager resourceMgr,
